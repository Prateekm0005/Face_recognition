...
class Face_Recognition:
    def __init__(self, root):
        ...
        #button
        b1=Button(f_lbl,command=self.face_recog,text="Face Recognition",cursor="hand2",font=("times new roman",18,"bold"),bg="darkgreen",fg="white")
        b1.place(x=365,y=625,width=200,height=40)
    
    #===================attendance===============
    def mark_attendance(self,i,r,n,d):
        with open("prateek.csv","r+",newline="\n") as f:
