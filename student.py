...
class Student:
    def __init__(self, root):
        ...
        #first image
        img=Image.open(r"C:\Users\admin\Desktop\face_recognition_system\college_images\facial-recognition_0.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\admin\Desktop\face_recognition_system\college_images\facialrecognition.png")
        ...
        #third image
        img2=Image.open(r"C:\Users\admin\Desktop\face_recognition_system\college_images\iStock-182059956_18390_t12.jpg")
        ...
        img_left=Image.open(r"C:\Users\admin\Desktop\face_recognition_system\college_images\AdobeStock_303989091.jpeg")
        ...
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=135,width=760,height=135)
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT","Civil","Agriculture","Mechanical")
        dep_combo.current(0)
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman",13,"bold"),width=17,state="read only")
        course_combo["values"]=("Select Course","B.TECH","M.TECH","MCA","BCA","BSC")
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",13,"bold"),state="read only",width=17)
        ...
        Semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",13,"bold"),state="read only",width=17)
        Semester_combo["values"]=("Select Semester","1st","2nd","3rd","4th","5th","6th","7th","8th")
        Semester_combo.current(0)
        Semester_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)

        #class student information
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Student informmation",font=("times new roman",12,"bold"))
        class_student_frame.place(x=5,y=250,width=760,height=290)
        ...
        div_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",13,"bold"),state="read only",width=17)
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("times new roman",13,"bold"),state="read only",width=17)
        ...
        Update_photo_btn=Button(button_frame1,text="Update photo",width=35,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\admin\Desktop\face_recognition_system\college_images\gettyimages-1022573162.jpg")
        ...
        search_combo=ttk.Combobox(Search_frame,font=("times new roman",12,"bold"),state="read only",width=14)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="1234",database="face_recognizer",auth_plugin='mysql_native_password')
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="1234",database="face_recognizer",auth_plugin='mysql_native_password')
                    my_cursor=conn.cursor()
                    my_cursor.execute("""   UPDATE student 
                                            SET Dep=%s, Course=%s, Year=%s, Semester=%s, Division=%s, Roll=%s, Gender=%s, DOB=%s, Email=%s, Phone=%s, Address=%s, Teacher=%s, PhotoSample=%s 
                                            WHERE StudentId=%s
                                            """, (
                                            self.var_dep.get(),
                                            self.var_course.get(),
                                            self.var_year.get(),
                                            self.var_semester.get(),
                                            self.var_div.get(),  # Corrected to use division
                                            self.var_roll.get(),
                                            self.var_gender.get(),
                                            self.var_dob.get(),
                                            self.var_email.get(),
                                            ...
                                            self.var_address.get(),
                                            self.var_teacher.get(),
                                            self.var_radio1.get(),  # Assuming this is the photo sample
                                            self.va_std_id.get()  # Corresponds to the StudentId in WHERE
                                        ))

                else:
                    if not Update:
                        return
                messagebox.showinfo("Success","Student Detail Completly Updated",parent=self.root)    
                conn.commit()
                self.fetch_data()
                conn.close                                                                                                                                                                                                        
            except Exception as es:
    ...
    def delete_data(self):
        if self.va_std_id.get()=="":
            messagebox.showerror("error","do you want to delelte the data")
        else:
            try:
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                my_cursor.execute("""   UPDATE student 
                                            ...
                                            self.var_teacher.get(),
                                            self.var_radio1.get(),  # Assuming this is the photo sample
                                            self.va_std_id.get()==id+1  # Corresponds to the StudentId in WHERE
                                        ))
                conn.commit()
                self.fetch_data()
                self.reset_data
